...
function App() {
  ...
  async function getNameAndBalance() {
    const res = await axios.get(`https://web3paypal-backend-dumyc9hqr-karthiks-projects-05a58192.vercel.app/?vercelToolbarCode=GWSGmXKnVTrZRqD/getNameAndBalance`, {
